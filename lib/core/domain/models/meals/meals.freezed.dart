...
mixin _$Meals {
  ...
  List<Ingredients> get listIngredients => throw _privateConstructorUsedError;
...
class _$MealsImpl with DiagnosticableTreeMixin implements _Meals {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('strDrinkAlternate', strDrinkAlternate))
      ...
      ..add(DiagnosticsProperty('strIngredient16', strIngredient16))
      ..add(DiagnosticsProperty('strIngredient17', strIngredient17))
      ..add(DiagnosticsProperty('strIngredient18', strIngredient18))
      ..add(DiagnosticsProperty('strIngredient19', strIngredient19))
      ..add(DiagnosticsProperty('strIngredient20', strIngredient20))
      ...
      ..add(DiagnosticsProperty('strMeasure16', strMeasure16))
      ..add(DiagnosticsProperty('strMeasure17', strMeasure17))
      ..add(DiagnosticsProperty('strMeasure18', strMeasure18))
      ..add(DiagnosticsProperty('strMeasure19', strMeasure19))
      ..add(DiagnosticsProperty('strMeasure20', strMeasure20))
      ..add(DiagnosticsProperty('strSource', strSource))
      ..add(DiagnosticsProperty('strImageSource', strImageSource))
      ..add(DiagnosticsProperty(
          'strCreativeCommonsConfirmed', strCreativeCommonsConfirmed))
      ..add(DiagnosticsProperty('dateModified', dateModified))
      ..add(DiagnosticsProperty('listIngredients', listIngredients));
  }
...
abstract class _Meals implements Meals {
  const factory _Meals(
      ...
      final String? strCreativeCommonsConfirmed,
      final String? dateModified,
      final List<Ingredients> listIngredients}) = _$MealsImpl;
